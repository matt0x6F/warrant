...
3. **Check the server:** Open **http://localhost:8080**. `GET /healthz` should return `ok`. To use MCP in Cursor, add the server URL and sign in when prompted—see **docs/cursor-mcp.md**.
